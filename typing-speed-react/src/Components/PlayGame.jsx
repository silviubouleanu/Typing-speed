...
const PlayGame = ({ onChangeScore }) => {
  const [defaultData] = useState(
    "siguranta viteza floare cerneala prietenie furtuna laptop calatorie carte dans zambet padure ploaie lumina ocean iubire soare munte melodie aventura vis timp galaxie stea dorinta"
  );
